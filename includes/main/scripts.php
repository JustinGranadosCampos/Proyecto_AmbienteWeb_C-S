<?php
    echo '<script src="../../vendor/jquery/jquery-3.3.1.min.js"></script>';
    echo '<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js"></script>';
    echo '<script src="../../vendor/bootstrap/bootstrap.min.js"></script>';
    echo '<script src="../../vendor/DataTables/datatables.min.js"></script>';
    echo '<script src="https://cdn.datatables.net/buttons/1.7.0/js/dataTables.buttons.min.js"></script>';
    ...
    echo '<script src="https://cdn.datatables.net/buttons/1.7.0/js/buttons.html5.min.js"></script>';
